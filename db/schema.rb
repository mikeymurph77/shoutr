...
ActiveRecord::Schema.define(version: 20140702135041) do
  ...
  add_index "following_relationships", ["follower_id", "followed_user_id"], name: "following_realitionships_uniquness_constraint", unique: true, using: :btree
